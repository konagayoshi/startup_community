...
ActiveRecord::Schema.define(version: 20160226043241) do
  ...
  add_index "jobdemands", ["company_id"], name: "index_jobdemands_on_company_id", using: :btree
  ...
  add_foreign_key "jobdemands", "companies"
